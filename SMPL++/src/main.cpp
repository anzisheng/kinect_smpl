...
{
public:
	// Высота ?ширина окна отображения
	int		width;
	int		height;
	int		gMouseX;
	int		gMouseY;
	...
	//--------------------------------------------------------------------------  
	// Функция обработк?нажати?кнопок мыши
	//--------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------
	// Функция обработк?перемещени?мыши
	//-------------------------------------------------------------------------- 
...
// 	cout << "xyz:" << endl << pred_xyz_jts_29 << endl;
	...
	//save it to file
	cnpy::npy_save("arr1.npy", &data[0], { Nz,Ny,Nx }, "w");//&data[0]: ЖрКјµШЦ·

	//load it into a new array
	cnpy::NpyArray arr = cnpy::npy_load("arr1.npy");
	std::complex<double>* loaded_data = arr.data<std::complex<double>>(); //ИЎµГКЧµШЦ·
